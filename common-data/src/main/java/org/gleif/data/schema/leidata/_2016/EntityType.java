    ...
    implements Serializable
{
    ...
    protected Date entityCreationDate;
    @XmlElement(name = "EntityExpirationDate", type = String.class)
    @XmlJavaTypeAdapter(Adapter1 .class)
    @XmlSchemaType(name = "dateTime")
    protected Date entityExpirationDate;
     ...
     *     
     */
    public void setEntityCreationDate(Date value) {
     ...
     *     
     */
    public void setEntityExpirationDate(Date value) {
