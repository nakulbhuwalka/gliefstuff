    ...
    implements Serializable
{
    ...
    protected List<ValidationAuthorityType> otherValidationAuthorities;
     ...
     * This is why there is not a <CODE>set</CODE> method for the otherValidationAuthorities property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOtherValidationAuthorities().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ValidationAuthorityType> getOtherValidationAuthorities() {
        if (otherValidationAuthorities == null) {
            otherValidationAuthorities = new ArrayList<ValidationAuthorityType>();
        }
        return this.otherValidationAuthorities;
    }
